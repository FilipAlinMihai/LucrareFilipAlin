...
legatura(4,s,cameraWW,cameraW).

legatura(4,s,debara,cameraNW).

legatura(4,n,cameraCapcana1,cameraNW).
legatura(4,e,cameraCapcana2,cameraNW).

legatura(4,e,cameraNW,biblioteca).
legatura(4,s,cameraNW,cameraCapcana1).
legatura(4,n,cameraNW,debara).
legatura(4,w,cameraNW,cameraCapcana2).

legatura(4,s,birou,biblioteca).

legatura(4,e,biblioteca,bucatarie).
legatura(4,n,biblioteca,birou):-cod_birou(X),codReal(Y),egale(X,Y).
legatura(4,n,biblioteca,birou):-fail.
legatura(4,w,biblioteca,cameraNW).
legatura(4,s,biblioteca,cameraNN).

legatura(4,n,cameraWS,cameraNN).
legatura(4,w,cameraWS,hol).

legatura(4,n,cameraNN,biblioteca).
legatura(4,s,cameraNN,cameraWS).

legatura(4,e,bucatarie,cameraNE).
legatura(4,w,bucatarie,biblioteca).
legatura(4,s,bucatarie,cameraE).

legatura(4,s,cameraE,cameraEN).
legatura(4,n,cameraE,bucatarie).
legatura(4,e,cameraE,cameraEE).

legatura(4,w,cameraEE,cameraE).
legatura(4,n,cameraEE,cameraNE).
legatura(4,s,cameraEE,cameraES).

legatura(4,n,cameraEN,cameraE).
legatura(4,n,cameraES,cameraEE).

legatura(4,s,cameraNE,cameraEE).
legatura(4,w,cameraNE,bucatarie).
