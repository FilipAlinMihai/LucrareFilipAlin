salveaza(Fisier):-
        ...
        downcase_atom(Lit6,Lit61),
        downcase_atom(Lit7,Lit71),
        downcase_atom(Lit8,Lit81),
        downcase_atom(Lit9,Lit91),
        downcase_atom(Lit10,Lit101),
...
incarca(Fisier):-
        ...
        upcase_atom(Lit6,Lit61),
        upcase_atom(Lit7,Lit71),
        upcase_atom(Lit8,Lit81),
        upcase_atom(Lit9,Lit91),
        upcase_atom(Lit10,Lit101),
        ...
        retract(avemLit1(_)),
        assert(avemLit1(Lit61)),
        retract(avemLit2(_)),
        assert(avemLit2(Lit71)),
        retract(avemLit3(_)),
        assert(avemLit3(Lit81)),
        retract(avemLit4(_)),
        assert(avemLit4(Lit91)),
        retract(avemLit5(_)),
        assert(avemLit5(Lit101)),!.
