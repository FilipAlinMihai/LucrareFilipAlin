...
** Cel mai probail cheia de la iesire se afla in birou dar acest aste blocat de un lacat. 
...
** Initial jucatorul trebuie sa selecteze dificultatea. Exista 4 nivele disponibile usor mediu dificil si imposibil. 
     Dificultatea e selectata prin comanda nivel/dificultate cu un argument, acesta fiind nivelul ales.
